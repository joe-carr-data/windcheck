...
Two limits of the benchmark, stated because they bound what it proves. The
injection copies a neighbouring wrap verbatim, whereas a real doubled-back trace
drifts onto the wrong wrap and follows it with its own local geometry --- so
this is an easier target than reality. And it is one host trace; varying the
host and weakening the copy are the obvious next steps.
